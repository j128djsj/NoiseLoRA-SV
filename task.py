...
from DatasetLoader import build_eval_loader, build_train_loader
from logger import build_logger
from losses import NoiseLoRASVLoss
from models import build_model
from optimizer import build_optimizer
from scheduler import build_scheduler
from utils import compute_eer, cosine_score, load_complete_baseline_checkpoint, load_full_model_checkpoint
from utils import save_training_checkpoint, set_seed, validate_config
from utils import format_parameter_summary, summarize_model_parameters
from utils.checkpoint import load_module_checkpoint, load_training_checkpoint
from utils.checkpoint import NOISELORA_REQUIRED_PREFIXES
...
class NoiseLoRASVTask:
    ...
    def train(self):
        ...
        ckpt_dir = self.cfg.get("paths", {}).get("checkpoint_dir", "pretrained/checkpoints")
